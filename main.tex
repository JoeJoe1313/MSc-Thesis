...
\noindent In Table 2 we see that PSMF and rPSMF attain lower RMSEs compared to all other methods and that they are competitive in terms of running time. The advantage of our method is especially noticeable on the NO2, SP500, and Gas datasets. \newline
...
\toprule
 ...
 & 20\% & 30\% & 40\% & 20\% & 30\% & 40\% \\
\midrule
PSMF & $\underset{{\scriptscriptstyle \;\;(16.70)}}{78.47}$ & $\underset{{\scriptscriptstyle \;\;(17.12)}}{83.25}$ & $\underset{{\scriptscriptstyle \;\;\;(23.85)}}{101.85}$ & 0.49 & 0.49 & 0.49 \\
rPSMF & $\underset{{\scriptscriptstyle \;\;(13.43)}}{\textbf{71.98}}$ & $\underset{{\scriptscriptstyle \;\;(12.51)}}{\textbf{73.97}}$ & $\underset{{\scriptscriptstyle \;\;(13.84)}}{\textbf{83.17}}$ & 0.56 & 0.55 & 0.56 \\
MLE-SMF & $\underset{{\scriptscriptstyle \;\;\;(45.29)}}{270.73}$ & $\underset{{\scriptscriptstyle \;\;\;(36.57)}}{246.62}$ & $\underset{{\scriptscriptstyle \;\;\;(40.50)}}{235.41}$ & 0.41 & 0.41 & 0.41 \\
TMF & $\underset{{\scriptscriptstyle \;\;\;(20.68)}}{202.45}$ & $\underset{{\scriptscriptstyle \;\;\;(16.31)}}{203.68}$ & $\underset{{\scriptscriptstyle \;\;\;(18.89)}}{208.68}$ & 0.17 & 0.17 & 0.17 \\
\bottomrule
\end{tabular}
\caption{Imputation error and runtime using 20\%, 30\% and 40\% missing values, averaged over 100 random repetitions. 300 missing data points per wave, rank 3.}
\end{table}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \begin{threeparttable}
            \begin{tabular}{lccc}
                ...
                \hline
                PSMF & 0.15 & 0.14 & 0.12 \\
                rPSMF & \textbf{0.86} & \textbf{0.82} & \textbf{0.77} \\
                MLE-SMF & 0.17 & 0.16 & 0.14 \\
                \hline
            \end{tabular}
        \end{threeparttable}
    \end{minipage}%
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \end{threeparttable}
    \end{minipage}
    \caption{Average coverage proportion of the missing data by the $2\sigma$ uncertainty bars of the posterior predictive estimates, averaged over 100 repetitions for both tables.}
\end{table}

TODO:
\begin{itemize}
    \item redo testing with correct dataset: done for 100 and 300 missing data points and ranks 3 and 10
    \item update tables results: done for 300 missing data points and rank 3
    \item mention rank 10 is worse, maybe show results?
    \item data used - no processing, aVR?
    \item algorithms tested: psmf, rpsmf, mle-smf, tmf
    \item coverage, results: done
    \item add figures showing the original data, missing parts and imputed parts: done
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{images/missing/psmf_input_300.pdf}
...
\begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/missing/psmf_output_300_20_3.pdf}
    \label{fig:limp}
\end{minipage}%
\hspace{0.05\linewidth}
\begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/missing/rpsmf_output_300_20_3.pdf}
    \label{fig:augmented}
\end{minipage}
...
\begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/missing/mlesmf_output_300_20_3.pdf}
    \label{fig:limp}
\end{minipage}%
\hspace{0.05\linewidth}
\begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/missing/tmf_output_300_20_3.pdf}
    \label{fig:augmented}
\end{minipage}
