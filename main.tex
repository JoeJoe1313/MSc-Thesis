...
Following the approach in Section \ref{subsec:aml}, for the negative log-likelihood we can obtain (\cite{akyildiz2021probabilistic})
\begin{equation}
    -\log \Tilde{p}_{\theta}(y_k | y_{1:k-1}) = 
\end{equation}
