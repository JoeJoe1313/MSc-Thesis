...
\noindent In Table \ref{tab:rmse3} we can find the results for $r = 3$ for each of the cases with $20\%$, $30\%$ and $40\%$ missing data. We see that PSMF and rPSMF have lower RMSEs compared to MLE-SMF and TMF, and that rPSMF slightly outperforms PSMF.  \newline
