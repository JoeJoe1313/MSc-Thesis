...
\begin{table}[h!]
\centering
\caption{Imputation error and runtime on several datasets using 20\%, 30\% and 40\% missing values, averaged over 100 random repetitions. An asterisk marks offline methods.}
\label{tab:my_label}
...
When forecasting... its hard to model the sharp peaks... smoother -> rmove reconstrution and set threshold and get the r-peaks
