...
\begin{itemize}
    \item Using $z_k$ instead of $y_k$ to represent the masked observations
    \item Updating the dictionary mean update to use $z_k$ and $M_k$
    \item Approximating the dictionary covariance update as $V_k \approx V_k \otimes I_d$
    \item Modifying the coefficient updates to use $M_k$ and $z_k$
    \item Clarifying the iterative and recursive parameter update steps
\end{itemize}
