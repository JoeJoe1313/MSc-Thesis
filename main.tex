...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Augmented Unipolar Limb Leads:} (aVR, aVL, aVF)
    \begin{itemize}
...
\noindent \textbf{Precordial Leads:} Placed across the chest, around the heart.
\begin{itemize}
    \item \textbf{V1 to V6:} These leads provide views of the horizontal plane of the heart, from right to left.
\end{itemize}

#### Equations and Lead Formations

- **Einthoven's Triangle**: This is a theoretical formation of the limb leads (I, II, III), forming an equilateral triangle with the heart at the center. The voltages in these leads relate to each other:
  - **Lead I + Lead III = Lead II**

This relationship helps in understanding the orientation and magnitude of the heart's electrical activity.

- **Augmented Limb Leads**: The voltages in these leads are calculated by amplifying the electrical difference between one limb electrode and a central point formed by the other limb electrodes:
  - **aVR = -(Lead I + Lead II)/2**
  - **aVL = Lead I - Lead II/2**
  - **aVF = Lead II - Lead I/2**

These relationships are based on the principle that the sum of the voltages from all three limb leads should be zero when the heart's electrical axis is normal.
